...
require_once('model/Guitarist.php');

class Guitarist_Controller{
	private $dbInstance;
	private $sql;
	...
	*/
	...
	function readAll(){
		return Guitarist::all();
	}

	function find($id){
		return Guitarist::find($id);
	}

	function update(){
		return Guitarist::update($this->set,$this->key);
	}
	function create(){
		return Guitarist::create($this->set);
	}
	function delete(){
        Guitarist::delete($this->key);
	}
}
?>